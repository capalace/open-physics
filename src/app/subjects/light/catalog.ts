...
export const lightDefinition: SubjectDefinition = {
  ...
  labs: [
    lab({
      ...
      steps: ["빛나는 노란 광원을 위아래로 끌어요.", "빛이 구멍을 지나는 위치를 맞춰요.", "거리별 광선 높이 그래프를 비교해요."],
    ...
    lab({
      ...
      steps: ["빛나는 거울을 잡아 원하는 각도로 돌려요.", "여러 거울 각도에서 반사광을 살펴봐요.", "입사각과 반사각 그래프를 비교해요."],
    ...
    lab({
      ...
      steps: ["빛나는 광원을 좌우로 끌어 입사각을 바꿔요.", "공기와 물 경계에서 꺾인 광선을 봐요.", "입사각과 굴절각 그래프를 비교해요."],
    ...
    lab({
      ...
      steps: ["유리 속 빛나는 광원을 좌우로 끌어요.", "임계각보다 작고 큰 각도를 번갈아 봐요.", "투과광과 반사광을 비교해요."],
    ...
    lab({
      ...
      steps: ["빛나는 물체 화살표를 좌우로 끌어요.", "렌즈 반대편에서 맺히는 상을 찾아요.", "물체 거리와 상의 크기 그래프를 비교해요."],
    ...
    lab({
      ...
      steps: ["빛나는 프리즘 꼭짓점을 잡아 돌려요.", "나오는 색 광선의 벌어짐을 살펴봐요.", "파장별 굴절각 스펙트럼을 비교해요."],
    ...
    lab({
      ...
      steps: ["빛나는 이중 슬릿의 구멍을 위아래로 끌어요.", "스크린의 밝은 무늬 간격을 살펴봐요.", "화면 위치별 빛의 세기 그래프를 비교해요."],
    ...
    lab({
      ...
      steps: ["빛나는 회전 편광판을 잡아 돌려요.", "각도에 따라 스크린 밝기를 살펴봐요.", "편광판 각도와 세기 그래프를 비교해요."],
    ...
    lab({
      ...
      steps: ["빛나는 접안렌즈를 좌우로 끌어요.", "렌즈를 지난 평행 광선의 기울기를 봐요.", "접안렌즈 초점거리와 배율을 비교해요."],
    ...
    lab({
      ...
      steps: ["왼쪽 설정에서 공급 에너지를 골라요.", "문턱보다 낮고 높은 값을 번갈아 봐요.", "공진기 안 광자와 출력 세기를 비교해요."],
