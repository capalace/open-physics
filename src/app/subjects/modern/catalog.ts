...
const labs: readonly SubjectLabDefinition[] = [
  {
    ...
    steps: ["주황빛으로 강조된 우주선 시계를 직접 끌어요.", "빛의 속도에 가까운 값도 골라 봐요.", "두 시계와 시간 그래프를 비교해요."],
  ...
  },
  {
    ...
    steps: ["주황색 좌우 조절 핸들을 끌어요.", "약한 중력과 강한 중력을 번갈아 봐요.", "휘어진 격자와 두 시계의 속도를 비교해요."],
  ...
  },
  {
    ...
    steps: ["주황색 위아래 조절 핸들을 다른 준위로 끌어요.", "서로 다른 에너지 준위를 바꿔 봐요.", "전이 화살표와 스펙트럼을 비교해요."],
  ...
  },
  {
    ...
    steps: ["주황빛으로 강조된 광자원을 직접 끌어요.", "문턱보다 낮고 높은 값을 번갈아 봐요.", "전자 검출과 에너지 그래프를 봐요."],
  ...
  },
  {
    ...
    steps: ["주황빛으로 강조된 입자원을 직접 끌어요.", "작은 값과 큰 값을 번갈아 봐요.", "확률 파장과 검출점을 비교해요."],
  ...
  },
  {
    ...
    steps: ["주황색 좌우 조절 핸들을 끌어요.", "좁은 폭과 넓은 폭을 번갈아 봐요.", "위치 확률분포와 운동량 불확정성을 비교해요."],
  ...
  },
  {
    ...
    steps: ["주황빛으로 강조된 장벽 끝을 직접 잡아요.", "좌우로 끌어 폭을 바꿔요.", "장벽 뒤 검출과 확률을 비교해요."],
  ...
  },
  {
    ...
    steps: ["주황빛으로 강조된 시간 탐침을 직접 끌어요.", "반감기 전후의 값을 번갈아 봐요.", "핵 표본과 붕괴 곡선을 비교해요."],
  ...
  },
  {
    ...
    steps: ["주황색 좌우 조절 핸들을 끌어요.", "작은 차이와 큰 차이를 번갈아 봐요.", "방출 광자와 에너지 그래프를 비교해요."],
  ...
  },
  {
    ...
    steps: ["주황색 좌우 조절 핸들을 끌어요.", "역방향과 순방향 전압을 번갈아 봐요.", "전하 흐름과 전류 곡선을 비교해요."],
